...
FlowRouter.route('/settings', {
  name: 'settings',
  waitOn() { return import('/imports/client/Settings'); },
  action(params, queryParams) {
    BlazeLayout.render('MainPage', { main: 'Settings' });
  }
});

FlowRouter.route('/commands', {
  name: 'commands',
  waitOn() { return import('/imports/client/CommandsTable'); },
  action(params, queryParams) {
    BlazeLayout.render('MainPage', { main: 'CommandsTable' });
  }
});
...
FlowRouter.route('/from', {
  name: 'from',
  waitOn() { return import('/imports/client/LocationsTable'); },
  action(params, queryParams) {
    Session.set('edit_mode', false);
    BlazeLayout.render('MainPage', { main: 'LatestLocations' });
  }
});
